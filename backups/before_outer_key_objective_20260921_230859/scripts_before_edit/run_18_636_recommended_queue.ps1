...
# Ordered campaign:
#   0. Record the already-confirmed 8-2-8 result without rerunning it.
#   1. Test the rm=3 candidates.
#   2. Test the rm=4 candidates.
#   3. Test the rm=5 candidates.
#   4. Finish with the two boundary/asymmetry cases.
$tasks = @(
    @{ rank = 0;  group = "confirmed"; r0 = 8; rm = 2; r1 = 8; reason = "already-confirmed 18-round distinguisher" },
    @{ rank = 1;  group = "P1-rm3";    r0 = 8; rm = 3; r1 = 7; reason = "preferred upper-long rm=3 candidate" },
    @{ rank = 2;  group = "P1-rm3";    r0 = 7; rm = 3; r1 = 8; reason = "mirror rm=3 candidate" },
    @{ rank = 3;  group = "P1-rm4";    r0 = 7; rm = 4; r1 = 7; reason = "balanced rm=4 candidate" },
    @{ rank = 4;  group = "P2-rm4";    r0 = 8; rm = 4; r1 = 6; reason = "upper-long rm=4 candidate" },
    @{ rank = 5;  group = "P2-rm4";    r0 = 6; rm = 4; r1 = 8; reason = "lower-long rm=4 candidate" },
    @{ rank = 6;  group = "P3-rm5";    r0 = 8; rm = 5; r1 = 5; reason = "upper-long rm=5 candidate" },
    @{ rank = 7;  group = "P3-rm5";    r0 = 7; rm = 5; r1 = 6; reason = "rm=5 directional candidate" },
    @{ rank = 8;  group = "P3-rm5";    r0 = 6; rm = 5; r1 = 7; reason = "rm=5 mirror candidate" },
    @{ rank = 9;  group = "P3-rm5";    r0 = 5; rm = 5; r1 = 8; reason = "lower-long rm=5 candidate" },
    # @{ rank = 10; group = "boundary";  r0 = 9; rm = 2; r1 = 7; reason = "existing boundary search; retry only if not successful" },
    @{ rank = 11; group = "boundary";  r0 = 7; rm = 2; r1 = 9; reason = "mirror boundary check" }
)

$singleMilpTimeLimitSec = 1200
$globalTimeLimitSec = 7200
